...
public class ObservationResource {
	...
	public Response addRecord(RecordMapping observation, @Context HttpServletRequest httpRequest) {
	...
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces(MediaType.APPLICATION_JSON)
    public Response create(ObservationMapping observation, @Context HttpServletRequest httpRequest) {
	...
	@Consumes({MediaType.APPLICATION_JSON})
	@Produces(MediaType.APPLICATION_JSON)
	public Response update(ObservationMapping observation, @PathParam("id") String id, @Context HttpServletRequest httpRequest) {
